...
axios.get('https://api.github.com/users/adammaley')
  .then((res) => {
    const user = res.data
...
function gitHubCardCreator(obj) {
  ...
  // appending to correct parents, some are nested
  ...
  // adding object properties to elements
  cardImage.src = obj.avatar_url;
  cardImage.alt = "github user image";
